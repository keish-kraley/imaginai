...
-- CreateEnum
CREATE TYPE "IdeaStatus" AS ENUM ('RECEIVED', 'IN_REVIEW', 'CONTACTED', 'COMPLETED');
...
CREATE TABLE "ApprovedIdea" (
    ...
    CONSTRAINT "ApprovedIdea_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "ApprovedIdea_messageId_key" ON "ApprovedIdea"("messageId");
...
-- AddForeignKey
ALTER TABLE "ApprovedIdea" ADD CONSTRAINT "ApprovedIdea_messageId_fkey" FOREIGN KEY ("messageId") REFERENCES "Message"("id") ON DELETE CASCADE ON UPDATE CASCADE;
